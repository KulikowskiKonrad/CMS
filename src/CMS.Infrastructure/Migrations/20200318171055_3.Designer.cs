...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMS.Domain.Models.CowAggregate.Cow", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CMS.Domain.Models.CowAggregate.Disease", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CMS.Domain.Models.CowAggregate.Cow", b =>
                {
                    ...
                    b.HasOne("CMS.Domain.Models.CowAggregate.Cow", "Father")
                        .WithMany()
                        .HasForeignKey("FatherId");

                    b.HasOne("CMS.Domain.Models.CowAggregate.Cow", "Mother")
                        .WithMany()
            ...
            modelBuilder.Entity("CMS.Domain.Models.CowAggregate.Disease", b =>
                {
                    b.HasOne("CMS.Domain.Models.CowAggregate.Cow", "Cow")
                        .WithMany("Diseases")
                        .HasForeignKey("CowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CMS.Domain.Models.CowAggregate.Pregnancy", b =>
                {
                    b.HasOne("CMS.Domain.Models.CowAggregate.Cow", "Child")
